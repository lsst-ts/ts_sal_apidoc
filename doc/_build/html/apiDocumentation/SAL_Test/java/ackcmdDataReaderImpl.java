...
public class ackcmdDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ackcmdDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private ackcmdTypeSupport typeSupport;

    public ackcmdDataReaderImpl(Test.ackcmdTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.ackcmdSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.ackcmdHolder received_data,
    ...
    */
    ...
    {
        return new ackcmdDataReaderViewImpl(typeSupport);
    }
}
