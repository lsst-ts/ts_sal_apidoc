...
public class ackcmdDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ackcmdDataWriter
{
    ...
    public ackcmdDataWriterImpl(Test.ackcmdTypeSupport ts)
    {
        typeSupport = ts;
