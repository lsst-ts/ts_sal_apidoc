...
public class arraysDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements arraysDataWriter
{
    ...
    public arraysDataWriterImpl(Test.arraysTypeSupport ts)
    {
        typeSupport = ts;
