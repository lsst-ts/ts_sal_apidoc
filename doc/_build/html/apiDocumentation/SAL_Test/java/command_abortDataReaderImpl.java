...
public class command_abortDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_abortDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_abortTypeSupport typeSupport;

    public command_abortDataReaderImpl(Test.command_abortTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_abortSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_abortHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_abortHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    {
        return new command_abortDataReaderViewImpl(typeSupport);
    }
}
