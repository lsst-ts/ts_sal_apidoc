...
public class command_enterControlDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_enterControlDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_enterControlTypeSupport typeSupport;

    public command_enterControlDataReaderImpl(Test.command_enterControlTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_enterControlSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_enterControlHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_enterControlHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.command_enterControl instance)
    {
        long uReader = 0;
    ...
    {
        return new command_enterControlDataReaderViewImpl(typeSupport);
    }
}
