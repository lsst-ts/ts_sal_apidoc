...
public class command_enterControl_abb0d976DataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_enterControl_abb0d976DataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_enterControl_abb0d976TypeSupport typeSupport;

    public command_enterControl_abb0d976DataReaderImpl(Test.command_enterControl_abb0d976TypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_enterControl_abb0d976SeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_enterControl_abb0d976Holder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_enterControl_abb0d976Holder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.command_enterControl_abb0d976 instance)
    {
        long uReader = 0;
    ...
    {
        return new command_enterControl_abb0d976DataReaderViewImpl(typeSupport);
    }
}
