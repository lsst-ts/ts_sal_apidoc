...
public class command_faultDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_faultDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_faultTypeSupport typeSupport;

    public command_faultDataReaderImpl(Test.command_faultTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_faultSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_faultHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_faultHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    {
        return new command_faultDataReaderViewImpl(typeSupport);
    }
}
