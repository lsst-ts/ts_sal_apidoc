...
public class command_setAuthListDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_setAuthListDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_setAuthListTypeSupport typeSupport;

    public command_setAuthListDataReaderImpl(Test.command_setAuthListTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_setAuthListSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_setAuthListHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_setAuthListHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.command_setAuthList instance)
    {
        long uReader = 0;
    ...
    {
        return new command_setAuthListDataReaderViewImpl(typeSupport);
    }
}
