...
public class command_setValueDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_setValueDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_setValueTypeSupport typeSupport;

    public command_setValueDataReaderImpl(Test.command_setValueTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_setValueSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_setValueHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_setValueHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.command_setValue instance)
    {
        long uReader = 0;
    ...
    {
        return new command_setValueDataReaderViewImpl(typeSupport);
    }
}
