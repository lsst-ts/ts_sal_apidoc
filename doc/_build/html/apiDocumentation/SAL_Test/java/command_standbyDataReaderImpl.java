...
public class command_standbyDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_standbyDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_standbyTypeSupport typeSupport;

    public command_standbyDataReaderImpl(Test.command_standbyTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_standbySeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_standbyHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_standbyHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    {
        return new command_standbyDataReaderViewImpl(typeSupport);
    }
}
