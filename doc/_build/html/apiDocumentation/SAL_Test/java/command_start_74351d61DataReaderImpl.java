...
public class command_start_74351d61DataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_start_74351d61DataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_start_74351d61TypeSupport typeSupport;

    public command_start_74351d61DataReaderImpl(Test.command_start_74351d61TypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_start_74351d61SeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_start_74351d61Holder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_start_74351d61Holder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.command_start_74351d61 instance)
    {
        long uReader = 0;
    ...
    {
        return new command_start_74351d61DataReaderViewImpl(typeSupport);
    }
}
