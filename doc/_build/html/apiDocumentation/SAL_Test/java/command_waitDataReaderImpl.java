...
public class command_waitDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements command_waitDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private command_waitTypeSupport typeSupport;

    public command_waitDataReaderImpl(Test.command_waitTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.command_waitSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.command_waitHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.command_waitHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    {
        return new command_waitDataReaderViewImpl(typeSupport);
    }
}
