...
public class logevent_authListDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_authListDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private logevent_authListTypeSupport typeSupport;

    public logevent_authListDataReaderImpl(Test.logevent_authListTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.logevent_authListSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.logevent_authListHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.logevent_authListHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.logevent_authList instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_authListDataReaderViewImpl(typeSupport);
    }
}
