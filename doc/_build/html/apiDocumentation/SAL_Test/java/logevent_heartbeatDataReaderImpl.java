...
public class logevent_heartbeatDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_heartbeatDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private logevent_heartbeatTypeSupport typeSupport;

    public logevent_heartbeatDataReaderImpl(Test.logevent_heartbeatTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.logevent_heartbeatSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.logevent_heartbeatHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.logevent_heartbeatHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.logevent_heartbeat instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_heartbeatDataReaderViewImpl(typeSupport);
    }
}
