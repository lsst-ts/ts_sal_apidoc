...
public class logevent_logLevelDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_logLevelDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private logevent_logLevelTypeSupport typeSupport;

    public logevent_logLevelDataReaderImpl(Test.logevent_logLevelTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.logevent_logLevelSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.logevent_logLevelHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.logevent_logLevelHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.logevent_logLevel instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_logLevelDataReaderViewImpl(typeSupport);
    }
}
