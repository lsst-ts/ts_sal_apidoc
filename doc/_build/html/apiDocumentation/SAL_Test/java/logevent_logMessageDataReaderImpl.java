...
public class logevent_logMessageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_logMessageDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private logevent_logMessageTypeSupport typeSupport;

    public logevent_logMessageDataReaderImpl(Test.logevent_logMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.logevent_logMessageSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.logevent_logMessageHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.logevent_logMessageHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.logevent_logMessage instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_logMessageDataReaderViewImpl(typeSupport);
    }
}
