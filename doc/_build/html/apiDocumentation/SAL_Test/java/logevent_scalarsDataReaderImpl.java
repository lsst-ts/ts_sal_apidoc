...
public class logevent_scalarsDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_scalarsDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private logevent_scalarsTypeSupport typeSupport;

    public logevent_scalarsDataReaderImpl(Test.logevent_scalarsTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.logevent_scalarsSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.logevent_scalarsHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.logevent_scalarsHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.logevent_scalars instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_scalarsDataReaderViewImpl(typeSupport);
    }
}
