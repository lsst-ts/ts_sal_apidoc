...
public class logevent_settingsAppliedDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_settingsAppliedDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private logevent_settingsAppliedTypeSupport typeSupport;

    public logevent_settingsAppliedDataReaderImpl(Test.logevent_settingsAppliedTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.logevent_settingsAppliedSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.logevent_settingsAppliedHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.logevent_settingsAppliedHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.logevent_settingsApplied instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_settingsAppliedDataReaderViewImpl(typeSupport);
    }
}
