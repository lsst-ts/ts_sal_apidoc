...
public class logevent_summaryStateDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements logevent_summaryStateDataReader
{
    private static final long serialVersionUID = 1L;

    private long copyCache;
    private logevent_summaryStateTypeSupport typeSupport;

    public logevent_summaryStateDataReaderImpl(Test.logevent_summaryStateTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            Test.logevent_summaryStateSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            Test.logevent_summaryStateHolder received_data,
    ...
    */
    ...
    synchronized public int get_key_value(
            Test.logevent_summaryStateHolder key_holder,
            long handle)
    {
        long uReader = 0;
        int result = DDS.RETCODE_ALREADY_DELETED.value;
    ...
    synchronized public long lookup_instance(
        Test.logevent_summaryState instance)
    {
        long uReader = 0;
    ...
    {
        return new logevent_summaryStateDataReaderViewImpl(typeSupport);
    }
}
