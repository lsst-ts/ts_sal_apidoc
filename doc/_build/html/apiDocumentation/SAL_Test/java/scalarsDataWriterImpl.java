...
public class scalarsDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements scalarsDataWriter
{
    ...
    public scalarsDataWriterImpl(Test.scalarsTypeSupport ts)
    {
        typeSupport = ts;
